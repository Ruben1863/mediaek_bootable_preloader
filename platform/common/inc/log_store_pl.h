...
#else
#define SRAM_LOG_ADDR (RAM_CONSOLE_SRAM_ADDR + 0xB00) // might be not right value
#endif
...
extern void pl_log_store(char c);
extern void store_switch_to_dram(void);
#else
inline void pl_log_store(char c)
{
}
inline void store_switch_to_dram(void)
{
}
#endif
