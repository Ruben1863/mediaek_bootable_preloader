...
void teei_secmem_param_prepare(u32 param_addr, u32 tee_entry, u32 teei_sec_dram_size,
                               u32 tee_smem_size) {
    int ret = 0;
    ...
    sec_mem_arg.svp_mem_start =
        tee_entry + teei_sec_dram_size - RESERVED_SEC_MEMORY_SIZE_FOR_SECURE_MEMORY_MGR;
...
#ifdef TEEI_DEBUG
    IMSG_DEBUG("%s sec_mem_arg.magic: 0x%x\n", __func__, sec_mem_arg.magic);
    IMSG_DEBUG("%s sec_mem_arg.version: 0x%x\n", __func__, sec_mem_arg.version);
    IMSG_DEBUG("%s sec_mem_arg.svp_mem_start: 0x%x\n", __func__, sec_mem_arg.svp_mem_start);
    IMSG_DEBUG("%s sec_mem_arg.svp_mem_end: 0x%x\n", __func__, sec_mem_arg.svp_mem_end);
    IMSG_DEBUG("%s sec_mem_arg.tplay_mem_start: 0x%x\n", __func__, sec_mem_arg.tplay_mem_start);
    IMSG_DEBUG("%s sec_mem_arg.tplay_mem_size: 0x%x\n", __func__, sec_mem_arg.tplay_mem_size);
    IMSG_DEBUG("%s sec_mem_arg.tplay_table_start: 0x%x\n", __func__, sec_mem_arg.tplay_table_start);
    IMSG_DEBUG("%s sec_mem_arg.tplay_table_size: 0x%x\n", __func__, sec_mem_arg.tplay_table_size);
    IMSG_DEBUG("%s sec_mem_arg.secmem_obfuscation: 0x%x\n", __func__,
               sec_mem_arg.secmem_obfuscation);
    IMSG_DEBUG("%s tee_entry_addr: 0x%x\n", __func__, tee_entry);
    IMSG_DEBUG("%s tee_secmem_size: 0x%x\n", __func__,
               tee_smem_size - RESERVED_SEC_MEMORY_SIZE_FOR_SECURE_MEMORY_MGR);
    IMSG_DEBUG("%s sec_mem_arg.shared_secmem: 0x%x\n", __func__, sec_mem_arg.shared_secmem);
    IMSG_DEBUG("%s sec_mem_arg.m4u_mem_start: 0x%x\n", __func__, sec_mem_arg.m4u_mem_start);
    IMSG_DEBUG("%s sec_mem_arg.m4u_mem_size: 0x%x\n", __func__, sec_mem_arg.m4u_mem_size);
    IMSG_DEBUG("%s sec_mem_arg.cmdq_mem_start: 0x%x\n", __func__, sec_mem_arg.cmdq_mem_start);
    IMSG_DEBUG("%s sec_mem_arg.cmdq_mem_size: 0x%x\n", __func__, sec_mem_arg.cmdq_mem_size);
#endif
